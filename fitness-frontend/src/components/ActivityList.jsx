      ...
      >
        <CardContent>
          ...
          <Typography variant="body2" sx={{ color: 'rgba(226,232,240,0.6)' }}>
            Log your first workout to unlock personalized insights and visual progress tracking.
          </Typography>
        </CardContent>
      </Card>
    )
  ...
  return (
    <Stack spacing={3}>
      <Stack direction={{ xs: 'column', md: 'row' }} spacing={2.5}>
        <Chip
          label={`Total Duration · ${summary.totalDuration} min`}
          color="primary"
          sx={{
            fontWeight: 600,
        ...
        />
        <Chip
          label={`Calories Burned · ${summary.totalCalories}`}
          sx={{
            fontWeight: 600,
                  ...
                  <Stack spacing={2.5}>
                    ...
                    <Stack spacing={1.25}>
                      <Typography variant="body2" sx={{ color: 'rgba(226,232,240,0.65)' }}>
                        Calories burned: <strong>{activity.caloriesBurned ?? 0}</strong>
                      </Typography>
                      {createdAt && (
                        <Typography variant="caption" sx={{ color: 'rgba(148, 163, 184, 0.7)' }}>
                          Logged {createdAt.toLocaleDateString(undefined, { month: 'short', day: 'numeric', year: 'numeric' })}
                        </Typography>
                      )}
                    </Stack>
                    <Typography variant="body2" sx={{ color: 'rgba(226,232,240,0.45)' }}>
                      Tap to unlock tailored recommendations and structured improvements for this session.
                    </Typography>
                  </Stack>
                </CardContent>
              </Card>
